...
df = pd.read_csv(r"C:\Users\seela\OneDrive\Desktop\KRANTHI\INTERNSHIP FILES\final_data.csv")
...
def search():
    if request.method == "POST":
        ...
        query_vectorization = vectorizer.transform([query])
        query_tfidf = tfidf_transformer.transform(query_vectorization)
